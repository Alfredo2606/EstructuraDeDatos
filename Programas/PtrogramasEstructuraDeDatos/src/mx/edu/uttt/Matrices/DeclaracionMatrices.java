    ...
    public static void main(String[] args) {
        ...
        * tipodedato nombreMatriz [][];
        ...
        String [] Nombresvector={"Juan Moroni",
                "Pablo Guerrero",
                "Atzin Bravo",
                "Kimberlyn Perez Hernandez"};
        String nombres [][] = {{"Luis Hernandez","Jorge Campos","Luis Garcia"},
                                {"Roberto Baggio","Ronaldo Nazario","Dr.GG"}};
        ...
        valor = alturas [alturas.length-1][alturas[alturas.length-1].length-1];//es la ultima y la ultima columna
